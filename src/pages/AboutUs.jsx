      ...
      <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 bg-white md:py-12 md:px-6 py-9 px-4">
        ...
        <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16 remove-flex-sm">
          <div className="w-full lg:w-6/12">
            ...
            At Town Treasure, our mission is to be the beacon for travelers, illuminating their path with comprehensive information about destinations worldwide. We're dedicated to democratizing travel knowledge on a grand scale, ensuring every adventurer has access to the insights they need. Just as BigBasket's guarantees stretch your dollar, our mission stretches your journey, providing invaluable guidance for every step. Whether it's uncovering hidden gems or navigating popular landmarks, Town Treasure is your trusted companion. Our commitment mirrors BigBasket's dedication to value, ensuring every traveler maximizes their experiences, enriched by the wealth of information we provide. Together, we redefine exploration, making every adventure unforgettable.
            </p>
